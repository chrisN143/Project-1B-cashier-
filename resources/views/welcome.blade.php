...
<head>
    <title>Smart Integrated System</title>
    <meta charset="utf-8" />
...
<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" class="bg-body position-relative app-blank">
    ...
    <script src="{{ asset('assets/templates/metronic/dist/assets/plugins/custom/fslightbox/fslightbox.bundle.js') }}">
    </script>
    <script src="{{ asset('assets/templates/metronic/dist/assets/plugins/custom/typedjs/typedjs.bundle.js') }}"></script>
    <!--end::Vendors Javascript-->
    <!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ asset('assets/templates/metronic/dist/assets/js/custom/landing.js') }}"></script>
    <script src="{{ asset('assets/templates/metronic/dist/assets/js/custom/pages/pricing/general.js') }}"></script>
