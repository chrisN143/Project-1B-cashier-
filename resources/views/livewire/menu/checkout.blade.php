...
<head>
    ...
    <style>
        @media only screen and (max-width: 600px) {
            ...
            /* Aturan CSS untuk perangkat dengan lebar maksimum 600px (misalnya, perangkat seluler) */
            .container {
                padding: 0;
            }
...
<body>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/js/all.min.js"
        integrity="sha512-hIFpuo/F8FLytxxFztQyRiaA8OhtEidPXzmOUXhFvYQoBODRaXy0fHHLF9c7plXbW+Z7SVgEpou+BOr9GTXkSg=="
